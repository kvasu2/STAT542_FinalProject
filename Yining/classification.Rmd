...
We fit the multiclass SVM model using One-vs-One approach, with using radial basis kernel. The overall mis-classification rate of kernel SVM is 0.188 and the accuracy is 0.812. The kernel SVM classifier outperforms k-NN and LDA. 
...
In addition, a linear SVM model is constructed to compare with the RBF kernel. The overall mis-classification rate of SVM is 0.09 and the accuracy is 0.91.
